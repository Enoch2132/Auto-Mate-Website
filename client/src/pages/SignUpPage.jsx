...
export function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 grid lg:grid-cols-2 min-h-screen">
        {/* Left Side - Branding */}
        <div className="bg-black flex flex-col justify-center items-center p-12 relative overflow-hidden">
          {/* Background gradient elements */}
          <div className="absolute inset-0">
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              {/* Main gradient square */}
              <div className="w-48 h-48 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 rounded-2xl relative">
                {/* Animated ring elements */}
                <div className="absolute -inset-8 border-2 border-cyan-400/30 rounded-3xl animate-pulse"></div>
                <div className="absolute -inset-12 border border-purple-500/20 rounded-full"></div>
        ...
        <div className="flex flex-col justify-center px-8 lg:px-16 py-12">
          <div className="max-w-md mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button 
                type="submit"
                className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white py-3 rounded-lg font-semibold"
              >
                Create Account
              </Button>
