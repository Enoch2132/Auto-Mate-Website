...
export const HeaderSection = (): JSX.Element => {
  ...
  return (
    <header className="flex items-center justify-between px-4 py-0.5 fixed top-5 left-0 right-0 mx-auto max-w-[1400px] h-[70px] bg-[#ffffff1a] border border-solid border-white backdrop-blur-[7.5px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(7.5px)_brightness(100%)] z-10">
